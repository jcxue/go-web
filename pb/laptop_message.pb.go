...
import (
	...
	proto "gitub.com/jcxue/go-web/proto"
...
type Laptop struct {
	...
	Cpu      *proto.CPU   `protobuf:"bytes,4,opt,name=cpu,proto3" json:"cpu,omitempty"`
	Ram      *Memory      `protobuf:"bytes,5,opt,name=ram,proto3" json:"ram,omitempty"`
	Gpus     []*proto.GPU `protobuf:"bytes,6,rep,name=gpus,proto3" json:"gpus,omitempty"`
...
func (x *Laptop) GetCpu() *proto.CPU {
	if x != nil {
		return x.Cpu
	}
	return nil
...
func (x *Laptop) GetGpus() []*proto.GPU {
	if x != nil {
		return x.Gpus
	}
	return nil
...
var file_laptop_message_proto_rawDesc = []byte{
	...
	0x65, 0x64, 0x41, 0x74, 0x42, 0x08, 0x0a, 0x06, 0x77, 0x65, 0x69, 0x67, 0x68, 0x74, 0x42, 0x23,
	0x5a, 0x21, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x6a, 0x63, 0x78,
	0x75, 0x65, 0x2f, 0x67, 0x6f, 0x2d, 0x77, 0x65, 0x62, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x3b,
