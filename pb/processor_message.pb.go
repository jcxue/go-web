...
import (
	proto "github.com/jcxue/go-web/proto"
...
type GPU struct {
	...
	Memory *proto.Memory `protobuf:"bytes,5,opt,name=memory,proto3" json:"memory,omitempty"`
}
...
func (x *GPU) GetMemory() *proto.Memory {
	if x != nil {
		return x.Memory
	}
	return nil
...
var file_processor_message_proto_rawDesc = []byte{
	...
	0x72, 0x79, 0x42, 0x22, 0x5a, 0x20, 0x67, 0x69, 0x74, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f,
	0x6a, 0x63, 0x78, 0x75, 0x65, 0x2f, 0x67, 0x6f, 0x2d, 0x77, 0x65, 0x62, 0x2f, 0x70, 0x72, 0x6f,
